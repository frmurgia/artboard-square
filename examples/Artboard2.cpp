...
* @public
*/
void Artboard2::setEnabled(bool enabled){
	if(enablePin!=-1){
...
//TOUCH ///////////
int Artboard2::touch(int channel){
...
*
**/
void Artboard2::write(int channel, int value){
